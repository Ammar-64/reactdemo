import {URL_LIST,URL_SEARCH, URL_DETAIL, URL_PERSON, URL_CAST, URL_VIDEO, API_KEY, API_KEY_ALT, RELATED_MOVIES} from '../const';
// action types
...
export const FETCH_RELATED_MOVIES = 'FETCH_RLATED_MOVIES';
export const FETCH_RELATED_MOVIES_SUCCESS = 'FETCH_RLATED_MOVIES_SUCCESS';
export const FETCH_RELATED_MOVIES_FAILURE = 'FETCH_RLATED_MOVIES_FAILURE';
...
export function fetchRelatedMoviesList(id){
  const url_RelatedMovies = URL_DETAIL + id + RELATED_MOVIES + API_KEY;
  return function(dispatch){
